...
class He(Initialization):
    ...
    def generate_layer(self, input_size: int, size: int) -> list:
        ...
        limit = driver.gcpu.sqrt(2 / input_size)
        return generator.normal(0, limit, size=(input_size, size))
    ...
    def kernel_filters(self, filter_number: int, filter_shape: tuple[int, int], channels_number: int):
        ...
        return generator.normal(0, limit, (*filter_shape, channels_number, filter_number))
