...
def main():
    ...
    config.add_filter(filter_number=32, filter_shape=(3, 3), activation=Relu()).add_polling((2, 2))
    config.add_filter(filter_number=64, filter_shape=(3, 3), activation=Relu()).add_polling((2, 2))
